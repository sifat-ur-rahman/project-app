  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-card flex items-center justify-center px-4 dark:from-slate-900 dark:to-slate-800">
      <div className="w-full max-w-md">
        ...
        {/* Login Form */}
        <form onSubmit={handleSubmit} className="bg-card rounded-lg border border-border p-6 space-y-4 mb-6">
          {error && (
        ...
        <div className="space-y-2 mb-6">
          <p className="text-sm text-muted-foreground text-center mb-3">Or try a demo account:</p>
          <Button
            type="button"
            variant="outline"
