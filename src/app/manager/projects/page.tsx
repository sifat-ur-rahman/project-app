 ...
 * 
 * Project management with limited permissions:
 * - Create new projects
 * - Edit own/assigned projects
    ...
    if (formData.name.trim()) {
      if (editingId) {
        ...
        const newProject: Project = {
          ...
          owner: 'You',
          ownerEmail: sessionStorage.getItem('userEmail') || 'pm@company.com',
          members: 1,
          progress: 0,
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Your managed projects - Create and edit only</p>
        </div>
        <Button
          onClick={() => {
            setEditingId(null);
      ...
      <div className="p-3 bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded">
        <p className="text-sm text-blue-900 dark:text-blue-200">
          You can create and edit projects, but cannot delete. Contact an admin to delete projects.
        </p>
      </div>
        ...
        {filteredProjects.map((project) => (
          <Card key={project.id} className="flex flex-col">
            ...
            <CardContent className="flex-1 space-y-4">
              ...
              {/* Actions - PM can only edit (no delete) */}
